...
- ``show_download_note`` (:ref:`show_download_note`)
...
By default, Sphinx-gallery writes a download note at the top of the example.

The ``show_download_note`` parameter can be used to disable it.
